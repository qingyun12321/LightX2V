...
WAN_T2V_PATH = os.path.join(PROJECT_ROOT, "examples", "wan", "wan_t2v_nvfp4.py")
WAN_I2V_PATH = os.path.join(PROJECT_ROOT, "examples", "wan", "wan_i2v_nvfp4.py")
...
wan_t2v = _load_module("wan_t2v_nvfp4", WAN_T2V_PATH)
wan_i2v = _load_module("wan_i2v_nvfp4", WAN_I2V_PATH)

app = FastAPI(title="LightX2V X2V NVFP4 API", version="1.0.0")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="LightX2V X2V NVFP4 API")
